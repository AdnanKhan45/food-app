...
import 'package:food_app/utils/button.dart';
                          ...
                          child: Stack(
                            children: [
                              Container(
                                ...
                                child: Center(
                                  child: Image.asset(
                                    "lib/assets/images/${widget.productData['image']}",
                                          ...
                                          children: [
                                            ...
                                            RichText(
                                                ...
                                                text: TextSpan(children: [
                                                  ...
                                                  TextSpan(
                                                      text: "${widget.productData['rest']}", style: textTheme.subtitle2!.apply(color: COLOR_GREY))
                                                ])),
                                          ],
                                        ),
                                        RichText(
                                        ...
                                        children: [
                                          RichText(
                                              ...
                                              text: TextSpan(children: [
                                                ...
                                                TextSpan(
                                                    text: "${widget.productData['rating']}", style: textTheme.bodyText2!.apply(fontWeightDelta: 4))
                                              ])),
                                          RichText(
                                              overflow: TextOverflow.ellipsis,
                                              text: TextSpan(children: [
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        color: Colors.red,
                                        boxShadow: [BoxShadow(color: Colors.red.withOpacity(0.2), blurRadius: 10.0, spreadRadius: 5.0)]),
                                    child: Icon(
                                      Icons.favorite,
                                      color: Colors.white,
                                      size: 35.0,
                ...
                if (!addedToCart) ...[
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.only(topLeft: Radius.circular(20.0), topRight: Radius.circular(20.0)), color: Colors.white),
                      child: Padding(
